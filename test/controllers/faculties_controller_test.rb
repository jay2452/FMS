...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { emp_id: @faculty.emp_id, name: @faculty.name } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { emp_id: @faculty.emp_id, name: @faculty.name } }
